...
class BookConfirmFragment : Fragment(), NetworkStateReceiver.NetworkStateReceiverListener{
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val view = inflater.inflate(R.layout.fragment_bookingconfirm, container, false)
...
//        initialize the layout items
        btn_back = view.findViewById(R.id.btn_conti)
